const institutions = [
  ...
  },
  {
    label: "IndusInd Bank",
    description:
      "IndusInd Bank Limited is an Indian financial services headquartered in Mumbai. The bank offers commercial, transactional and electronic banking products and services.",
  },
  {
    label: "ICICI Bank",
    description:
